...
open class CoreDataStack {
    static let modelName = "GameOfThrones"
    ...
    lazy var storeContainer: NSPersistentContainer = {
      ...
      container.loadPersistentStores { _, error in
        if let error = error as NSError? {
            //TODO: Fatal errors might be usefull for development time to see failures staright. But we need better approach for prod.
